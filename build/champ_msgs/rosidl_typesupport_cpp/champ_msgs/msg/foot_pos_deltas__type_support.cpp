...
static const _FootPosDeltas_type_support_symbol_names_t _FootPosDeltas_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, champ_msgs, msg, FootPosDeltas)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, champ_msgs, msg, FootPosDeltas)),
  }
};
...
{
  return &::champ_msgs::msg::rosidl_typesupport_cpp::FootPosDeltas_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, champ_msgs, msg, FootPosDeltas)() {
  return get_message_type_support_handle<champ_msgs::msg::FootPosDeltas>();
}
