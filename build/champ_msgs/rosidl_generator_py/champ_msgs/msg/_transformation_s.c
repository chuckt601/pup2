...
bool champ_msgs__msg__transformation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("champ_msgs.msg._transformation.Transformation", full_classname_dest, 45) == 0);
  }
  champ_msgs__msg__Transformation * ros_message = _ros_message;
  {  // translation
...
{
  /* NOTE(esteve): Call constructor of Transformation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("champ_msgs.msg._transformation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Transformation");
