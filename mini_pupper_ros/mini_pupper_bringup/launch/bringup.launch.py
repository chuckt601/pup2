...
def generate_launch_description():
    ...
    bno055_launch_path = PathJoinSubstitution(
        [FindPackageShare('bno055'), 'launch', 'bno055.launch.py']
    )
    champ_teleop_launch_path = PathJoinSubstitution(
        [FindPackageShare('champ_teleop'), 'launch', 'champ_teleop_only.launch.py']
    )
    ...
    champ_teleop_launch = IncludeLaunchDescription(
